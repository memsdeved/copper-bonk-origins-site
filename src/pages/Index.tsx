...
const Index = () => {
  return (
    <div className="min-h-screen bg-background text-foreground">
      {/* Navbar */}
      <nav className="sticky top-0 bg-white/80 backdrop-blur-md z-50 border-b border-copper-light/30">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-6">
            <a href="#truth" className="text-foreground hover:text-copper transition-colors">The Truth</a>
            <a href="#why" className="text-foreground hover:text-copper transition-colors">Why $COPPER</a>
            <a href="#token" className="text-foreground hover:text-copper transition-colors">Token Info</a>
            <a href="#community" className="text-foreground hover:text-copper transition-colors">Community</a>
            <a href="#faq" className="text-foreground hover:text-copper transition-colors">FAQ</a>
          </div>
      ...
      <section className="relative min-h-[80vh] flex items-center py-16">
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -right-10 -top-10 w-64 h-64 rounded-full bg-copper-light/20 blur-3xl"></div>
        ...
        <div className="container mx-auto px-4 relative z-10 flex flex-col lg:flex-row items-center">
          <div className="lg:w-1/2 mb-10 lg:mb-0">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 font-['Impact'] leading-tight">
              THE BONK DOG WAS <span className="bg-gradient-to-r from-copper to-copper-accent bg-clip-text text-transparent">NEVER CHEEMS...</span>
            </h1>
            
            <h2 className="text-xl md:text-2xl mb-8 font-['Comic_Sans_MS'] text-foreground/70">
              Meet Copper — the Shiba who ate a scorpion and became legend.
            </h2>
            
            <div className="flex flex-wrap gap-4">
              <Button className="bg-copper hover:bg-copper-dark text-white" size="lg">
                <a href="https://letsbonk.fun/token/Cft3gDDE72M833wN1C6rZgJLjse1X2EXMUgXVVfcbonk" target="_blank" rel="noopener noreferrer">
                  $COPPER on Letsbonk.fun
                </a>
              </Button>
          ...
          <div className="lg:w-1/2 flex justify-center">
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-br from-copper-accent/30 to-copper-light/30 blur-xl"></div>
              <div className="relative border-4 border-copper/30 overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-copper/20 to-copper-light/20"></div>
                <img 
      ...
      <section id="truth" className="py-20 bg-white/60">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-16 font-['Impact']">
            <span className="bg-gradient-to-r from-copper to-copper-accent bg-clip-text text-transparent">THE TRUTH</span> UNCOVERED
          </h2>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="relative pl-10 pb-10 border-l-2 border-copper">
              ...
              <div className="ml-8">
                ...
                <div className="mt-4 p-4 bg-copper-light/20 border-l-4 border-copper-accent italic">
                  ...
                  <div className="text-sm text-foreground/50 mt-2">— KnowYourMeme Archive, 2018</div>
                </div>
              </div>
            </div>
            ...
            <div className="relative pl-10 border-l-2 border-copper">
              ...
              <div className="ml-8">
                ...
                <div className="mt-4 mb-4 mx-auto max-w-lg border-2 border-copper-light rounded-lg overflow-hidden shadow-lg">
                  <img 
                    ...
                    className="w-full"
                  />
                  <div className="bg-copper-light/20 p-3 text-sm text-foreground/70 italic">
            ...
            <div className="mt-8 flex justify-center">
              <Button className="bg-copper text-white hover:bg-copper-dark">
      ...
      {/* Why $COPPER */}
      <section id="why" className="py-20 bg-copper-light/10">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-16 font-['Impact']">
            WHY <span className="bg-gradient-to-r from-copper to-copper-accent bg-clip-text text-transparent">$COPPER</span>?
          </h2>
          
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <Card className="bg-white/80 backdrop-blur-sm border border-copper-light/30 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02]">
              <CardContent className="p-6">
                <div className="w-12 h-12 bg-copper-light/30 rounded-full flex items-center justify-center mb-4">
      ...
      {/* Token Info */}
      <section id="token" className="py-20 bg-gradient-to-b from-white to-copper-light/10">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-16 font-['Impact']">
            TOKEN <span className="bg-gradient-to-r from-copper to-copper-accent bg-clip-text text-transparent">INFO</span>
          </h2>
          
          <div className="max-w-3xl mx-auto bg-white/80 backdrop-blur-sm border border-copper-light/30 rounded-2xl p-8 shadow-lg">
            <div className="space-y-4">
              <div className="flex justify-between items-center border-b border-copper-light/20 pb-3">
              ...
              <div className="flex justify-between items-center border-b border-copper-light/20 pb-3">
                ...
                <div className="flex items-center">
                  <span className="text-sm text-foreground/70 mr-2 font-mono">Cft3gDDE72M833wN1C6rZgJLjse1X2EXMUgXVVfcbonk</span>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-8 font-['Impact']">
              <span className="bg-gradient-to-r from-copper to-copper-accent bg-clip-text text-transparent">COPPER'S</span> LEGACY
            </h2>
            ...
            <div className="flex justify-center">
              ...
              >
                <Button className="bg-copper hover:bg-copper-dark text-white flex items-center gap-2">
                  <X className="h-4 w-4" />
                  Join X Community
                </Button>
              </a>
      ...
      <section id="faq" className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-16 font-['Impact']">
            <span className="bg-gradient-to-r from-copper to-copper-accent bg-clip-text text-transparent">FREQUENTLY</span> ASKED QUESTIONS
          </h2>
          
          <div className="max-w-3xl mx-auto">
            <Accordion type="single" collapsible className="space-y-4">
              <AccordionItem value="item-1" className="border border-copper-light/30 rounded-lg overflow-hidden bg-white shadow-sm">
                <AccordionTrigger className="px-6 py-4 font-semibold text-left hover:bg-copper-light/10">
                  Is this a joke?
                </AccordionTrigger>
              ...
              <AccordionItem value="item-2" className="border border-copper-light/30 rounded-lg overflow-hidden bg-white shadow-sm">
                <AccordionTrigger className="px-6 py-4 font-semibold text-left hover:bg-copper-light/10">
                  Is Copper real?
                </AccordionTrigger>
                <AccordionContent className="px-6 pb-4 text-foreground/70">
              ...
              <AccordionItem value="item-3" className="border border-copper-light/30 rounded-lg overflow-hidden bg-white shadow-sm">
                <AccordionTrigger className="px-6 py-4 font-semibold text-left hover:bg-copper-light/10">
      ...
      {/* Footer */}
      <footer className="py-8 bg-copper-dark text-copper-light">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="text-sm text-copper-light/70">
